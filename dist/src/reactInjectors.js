...
function injectGlobalReactCodePre({ contentManager, typescriptCodegenOutputPath, withUpdates, }) {
    ...
    contentManager.addImport(`import { QueryHookOptions, useQuery, LazyQueryHookOptions, useLazyQuery, MutationHookOptions, useMutation, QueryLazyOptions, MutationFunctionOptions, LazyQueryResult, MutationTuple, FetchResult, MutationResult, SubscriptionResult, SubscriptionHookOptions, useSubscription, ApolloError, SubscribeToMoreOptions } from '@apollo/client';`);
...
function injectInsertReact({ contentManager, entityName, fragmentName, trimString, primaryKeyIdField, typescriptCodegenOutputPath, }) {
    ...
    export type Insert${fragmentNamePascalCase}LazyMutationReturn = [Insert${fragmentNamePascalCase}WrappedLazyMutationFn, MutationResult<Insert${fragmentNamePascalCase}Mutation> & ${fragmentNamePascalCase}ByIdHookResultEx];
  ...
  `);
    ...
    export type Insert${fragmentNamePascalCase}WithOnConflictLazyMutationReturn = [Insert${fragmentNamePascalCase}WithOnConflictWrappedLazyMutationFn, MutationResult<Insert${fragmentNamePascalCase}WithOnConflictMutation> & ${fragmentNamePascalCase}ByIdHookResultEx];
  ...
  `);
    ...
    contentManager.addImport(_1.makeImportStatement(`Insert${fragmentNamePascalCase}WithOnConflictMutation`, typescriptCodegenOutputPath));
...
function injectUpdateReact({ contentManager, entityName, fragmentName, trimString, primaryKeyIdField, typescriptCodegenOutputPath, }) {
    ...
    export type Update${fragmentNamePascalCase}ByIdLazyMutationReturn = [Update${fragmentNamePascalCase}ByIdWrappedLazyMutationFn, MutationResult<Update${fragmentNamePascalCase}ByIdMutation> & ${fragmentNamePascalCase}ByIdHookResultEx];
